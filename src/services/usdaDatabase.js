...
export const USDA_DATABASE = [
  ...
  {
    id: 'sesame_seeds', name: 'White Sesame Seeds / Til', category: 'Nuts & Seeds', diet: 'vegan', servingUnit: '1 tbsp (10g)', servingGram: 10, icon: '⚪', practicalDaily: true,
    keywords: ['sesame', 'til', 'calcium booster', 'iron', 'magnesium', 'copper'],
    nutrientsPer100g: {
      calories: 573, protein: 17.7, carbs: 23.4, fiber: 11.8, totalFat: 49.7, satFat: 7.0, monoFat: 18.8, polyFat: 21.8, sugar: 0.3, water: 5, omega3: 0.38, omega6: 21.4, cholesterol: 0,
      vitaminA: 1, vitaminC: 0, vitaminD: 0, vitaminE: 0.25, vitaminK: 0, thiaminB1: 0.79, riboflavinB2: 0.25, niacinB3: 4.5, vitaminB6: 0.79, folateB9: 97, vitaminB12: 0, biotinB7: 5.0, pantothenicAcidB5: 0.05, choline: 25.6,
      calcium: 975, iron: 14.6, magnesium: 351, phosphorus: 629, potassium: 468, sodium: 11, zinc: 7.8, copper: 4.08, manganese: 2.46, selenium: 34.4, iodine: 2.0, chromium: 4.0, molybdenum: 8.0
    }
  },
  {
